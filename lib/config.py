...
sentinel_cfg = XchangeConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_Xchanged_proto_version_with_sentinel_ping = 70207


def get_Xchange_conf():
    home = os.environ.get('HOME')

    Xchange_conf = os.path.join(home, ".Xchangecore/Xchange.conf")
    if sys.platform == 'darwin':
        Xchange_conf = os.path.join(home, "Library/Application Support/XchangeCore/Xchange.conf")

    Xchange_conf = sentinel_cfg.get('Xchange_conf', Xchange_conf)
