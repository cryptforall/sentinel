...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to Xchanged "gobject list" output
    ...
    def Xchanged_serialise(self):
        import Xchangelib
        return Xchangelib.SHIM_serialise_for_Xchanged(self.serialise())
